...
@Index('fatostatusatendimentohistoricoipea_pkey', ['id'], { unique: true })
@Index('ftsttstndimentohistoricoipeafkftsttstndimentohistoricoipeaidapl', ['idapl'], {})
@Index('ftsttstndmnthstrcpeafkftsttstndmnthstrcoipeaidatendimentostatus', ['idatendimentostatus'], {})
@Index('ftsttstndmnthstoricoipeafkftsttstndmnthistoricoipeaidcalendario', ['idcalendario'], {})
@Index('ftsttstndmntohistoricoipeafkftsttstndmntohistoricoipeaidcliente', ['idcliente'], {})
@Index('ftsttstndmntohistoricoipeafkftsttstndimentohistoricoipeaidsetor', ['idsetor'], {})
@Index('ftsttstndmnthstrcpeafkftsttstndmnthstrcoipeaidunidadefederativa', ['idunidadefederativa'], {})
@Index('ftsttstndmnthstrcipeafkftsttstndmnthstricoipeaidunidadenacional', ['idunidadenacional'], {})
@Index('ftsttstndmnthstrcpeafkftsttstndmnthstrcipeaidunidadeoperacional', ['idunidadeoperacional'], {})
@Index('ftsttstndmnthstrcipeafkftsttstndmnthstricoipeaidunidaderegional', ['idunidaderegional'], {})
@Entity('fatostatusatendimentohistoricoipea', { schema: 'public' })
export class Fatostatusatendimentohistoricoipea {
  ...
  @ManyToOne(() => Apl, (apl) => apl.fatostatusatendimentohistoricoipeas)
  @JoinColumn([{ name: 'idapl', referencedColumnName: 'id' }])
  idapl2: Apl;

  @ManyToOne(() => Atendimentostatus, (atendimentostatus) => atendimentostatus.fatostatusatendimentohistoricoipeas)
  @JoinColumn([{ name: 'idatendimentostatus', referencedColumnName: 'id' }])
  idatendimentostatus2: Atendimentostatus;

  @ManyToOne(() => Calendario, (calendario) => calendario.fatostatusatendimentohistoricoipeas)
  @JoinColumn([{ name: 'idcalendario', referencedColumnName: 'id' }])
  idcalendario2: Calendario;

  @ManyToOne(() => Cliente, (cliente) => cliente.fatostatusatendimentohistoricoipeas)
  @JoinColumn([{ name: 'idcliente', referencedColumnName: 'id' }])
  idcliente2: Cliente;

  @ManyToOne(() => Setor, (setor) => setor.fatostatusatendimentohistoricoipeas)
  @JoinColumn([{ name: 'idsetor', referencedColumnName: 'id' }])
  idsetor2: Setor;

  @ManyToOne(() => Unidadefederativa, (unidadefederativa) => unidadefederativa.fatostatusatendimentohistoricoipeas)
  @JoinColumn([{ name: 'idunidadefederativa', referencedColumnName: 'id' }])
  idunidadefederativa2: Unidadefederativa;

  @ManyToOne(() => Unidade, (unidade) => unidade.fatostatusatendimentohistoricoipeas)
  @JoinColumn([{ name: 'idunidadenacional', referencedColumnName: 'id' }])
  idunidadenacional2: Unidade;

  @ManyToOne(() => Unidade, (unidade) => unidade.fatostatusatendimentohistoricoipeas2)
  @JoinColumn([{ name: 'idunidadeoperacional', referencedColumnName: 'id' }])
  idunidadeoperacional2: Unidade;

  @ManyToOne(() => Unidade, (unidade) => unidade.fatostatusatendimentohistoricoipeas3)
